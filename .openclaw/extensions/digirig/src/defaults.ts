...
export const DEFAULT_PTT_LEAD_MS = 120;
export const DEFAULT_PTT_TAIL_MS = 120;

export const DEFAULT_RX_ENERGY_THRESHOLD = 0.02;
export const DEFAULT_RX_FRAME_MS = 20;
export const DEFAULT_RX_PRE_ROLL_MS = 150;
export const DEFAULT_RX_MIN_SPEECH_MS = 200;
export const DEFAULT_RX_MAX_SILENCE_MS = 700;
export const DEFAULT_RX_MAX_RECORD_MS = 10000;
export const DEFAULT_RX_BUSY_HOLD_MS = 300;
